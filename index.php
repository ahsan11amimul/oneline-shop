  ...
  <script src="main.js"></script>
	...
	<body>
		...
		<nav class="navbar navbar-inverse">
            ...
            -->
				<ul class="nav navbar-nav navbar-right">
					<li><a class="dropdown-toggle" data-toggle="dropdown"  href="#"><span class="glyphicon glyphicon-shopping-cart"></span> Cart<span class="badge"></span></a>
                     ...
                     <li><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-log-in caret"></span> Login</a>
                     	<ul class="dropdown-menu">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-1">
					<a href="admintest.php">Adminlogin</a>
				</div>
				<div class="col-sm-2">
